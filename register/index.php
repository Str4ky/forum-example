...
<html>
  ...
  <body>
    ...
    <button onclick="topFunction()" id="myBtn" title="Retourner en haut de page"><i class="fa fa-arrow-up" aria-hidden="true"></i></button>
        ...
        <?php
            if($_SESSION['email'] != '') {
                echo "<center><p>Vous êtes déjà connecté</p><a <a href='../' class='button cl1'>Retourer à l'accueil</a><br><br></div></center>";
            }
            else {
                echo "<div class='text'>
                <center>
                    <form method='post' action='../script/register.php'>
                        ...
                        <input type='text' name='nom' id='nom' placeholder='Entrez votre pseudo' required/><br>
                        <label for='email'>Adresse email </label><br><br>
                        <input type='email' name='email' id='email' placeholder='Entrez votre adresse email' required/><br>
                        <label for='password'>Mot de passe</label><br><br>
                        <input type='password' name='password' id='password' placeholder='Entrez votre mot de passe' minlength='8' required/><br>
                        <input type='submit' value='S&apos;inscrire' class='button cl1'/><br><br><br>
                    </form>
                </center>
            </div>
            </div>";
